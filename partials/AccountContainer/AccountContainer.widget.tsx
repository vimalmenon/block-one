...
export const AccountContainer:React.FC<AccountContainerProps> = ({title, accounts, onAccountSelect, selectedAccount, transferAmount, isFromAccount, setTransferAmount}) => {
    const onAmountUpdate = (e:any) => {
    ...
    return (
        <div className="flex w-5/12 flex-col border shadow">
            <div className="flex h-20 text-3xl items-center justify-center">
                {title}
            </div>
            <div className="flex flex-col">
                ...
                {selectedAccount?.customerId ? 
                    <>
                        ...
                        <div className="w-full flex p-4">
                            ...
                            <div className="flex w-2/3">
                                {convertCurrency(selectedAccount?.balance)}
                            </div>
                        </div>
                    </>:
                    null
                ...
                {selectedAccount?.balance && !isFromAccount && transferAmount? 
                    <div className="w-full flex p-4">
                        ...
                        <div className="flex w-2/3">
                            {selectedAccount?.balance + transferAmount}
                        </div>
                    </div> :
                    null
                }
